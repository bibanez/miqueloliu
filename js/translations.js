...
const TRANSLATIONS = {
  ...
  ca: {
    ...
    'works.detail.back':     '← Obres',
    'works.detail.language.label': 'Text de la nota',
  ...
  es: {
    ...
    'works.link.note':       'nota de programa',
    'works.link.info':       '+info',
    'works.detail.back':     '← Obras',
    'works.detail.language.label': 'Idioma de la nota',
  ...
  en: {
    ...
    'works.link.info':       '+info',
    'works.detail.back':     '← Works',
    'works.detail.language.label': 'Programme note language',
